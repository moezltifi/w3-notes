const javascript = {
  ...
  "JS Array Iteration": [
    "<h2 style='text-align: center;'>JavaScript Array Iteration</h2>",
    "<li>Array iteration methods operate on every array item:</li>",
    "<li>The forEach() method calls a function (a callback function) once for each array element.</li>",
    ...
    "<li>The filter() method creates a new array with array elements that pass a test.</li>",
    "<li>The reduce() and reduceRight() methods runs a function on each array element to produce (reduce it to) a single value.</li>",
    "<li>The reduce() method works from left-to-right in the array.</li>",
    "<li>The reduceRight() works from right-to-left in the array.</li>",
    "<li>The every() method checks if all array values pass a test.</li>",
    "<li>The some() method checks if some array values pass a test.</li>",
    "<li>The Array.from() method returns an Array object from any object with a length property or any iterable object.</li>",
    "<li>The Array.keys() method returns an Array Iterator object with the keys (index) of an array.</li>",
  ...
  "JS Date Get Methods": [
    "<h2 style='text-align: center;'>JavaScript Date Get Methods</h2>",
    "<li>In JavaScript, date objects are created with new Date().</li>",
    "<li>new Date() returns a date object with the current date and time.</li>",
    "<li>Date Get Methods:</li>",
    "<ul><li>getFullYear():	Get year as a four digit number (yyyy)</li>",
    ...
    "<li>getTime():	Get time (milliseconds since January 1, 1970)</li></ul>",
  ],
  "JS Date Set Methods": [
    "<h2 style='text-align: center;'>JavaScript Date Set Methods</h2>",
    "<li>In JavaScript, date objects are created with new Date().</li>",
    "<li>new Date() returns a date object with the current date and time we can edit it using:</li>",
    "<li>Date Set Methods:</li>",
    "<ul><li>setFullYear():	Set the year as a four digit number (yyyy)</li>",
    "<li>setMonth():	Set the month as a number (0-11)</li>",
    "<li>setDate():	Set the day as a number (1-31)</li>",
    "<li>setDay():	Set the weekday as a number (0-6)</li>",
    "<li>setHours():	Set the hour (0-23)</li>",
    "<li>setMinutes():	Set the minute (0-59)</li>",
    "<li>setSeconds():	Set the second (0-59)</li>",
    "<li>setMilliseconds():	Set the millisecond (0-999)</li>",
    "<li>setTime():	Set the time (milliseconds since January 1, 1970)</li></ul>",
  ],
  "JS Math": [
  ...
  "JS Random": [
    "<h2 style='text-align: center;'>JavaScript Random</h2>",
    "<li>Math.random() returns a random number between 0 and 1:</li>",
    "<code>Math.random(); // Returns a random number</code>",
    "<li>Math.random() used with Math.floor() can be used to return random integers.</li>",
