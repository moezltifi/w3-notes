const html = {
  ...
  "HTML Elements": [
    ...
    "<code>&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br>&lt;h1&gt;My First Heading&lt;/h1&gt;<br>&lt;p&gt;My first paragraph.&lt;/p&gt;<br>&lt;/body&gt;<br>&lt;/html&gt;</code>",
    "<li>Examples of some HTML elements:</li>",
    "<ul><li><code>&lt;button&gt;Click me&lt;/button&gt;</code></li>",
  ...
  "HTML Attributes": [
    ...
    "<li>Examples of attribute usage:</li>",
    "<code>&lt;p class='intro'&gt;This is an introductory paragraph.&lt;/p&gt;</code>",
    "<code>&lt;head&gt;<br>&lt;meta charset='utf-8'&gt;<br>&lt;/head&gt;</code>",
  ...
  "HTML Links": [
    ...
    "<p>We use the path of a file if it is a local file:</p>",
    "<code>&lt;a href='index.html'&gt;Local HTML Page&lt;/a&gt;</code>",
    "<a href='index.html'>Local HTML Page</a>"
],
