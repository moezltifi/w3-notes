const css = {
  ...
  "CSS Colors": [
    "<h2 style='text-align: center;'>CSS Colors</h2>",
  ...
  "CSS Responsive": [
    "<h2 style='text-align: center;'>CSS Responsive</h2>",
    "<li>Responsive web design makes your web page look good on all devices.</li>",
    "<li>Responsive web design uses only HTML and CSS is not a program or a JavaScript.</li>",
    "<li>Media query is a CSS technique introduced in CSS3. It uses the <code>@media</code> rule to include a block of CSS properties only if a certain condition is true.</li>",
    "<li>Media queries can help with this. We can add a breakpoint where certain parts of the design will behave differently on either side of the breakpoint.</li>",
    "<li>There are tons of screens and devices with different heights and widths, so it is hard to create an exact breakpoint for each device. To keep things simple you could target five groups:</li>",
    "<ol><li> <code>@media (max-width: 600px) {...}</code> Extra small devices </li>",
    "<li> <code>@media (min-width: 600px) {...}</code> Small devices</li>",
    "<li> <code>@media (min-width: 768px) {...}</code> Medium devices</li>",
    "<li> <code>@media (min-width: 992px) {...}</code> Large devices</li>",
  ...
  "CSS Attr Selectors": [
    "<h2 style='text-align: center;'>CSS Attr Selectors</h2>",
