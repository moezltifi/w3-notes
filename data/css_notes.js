const css = {
  ...
  "CSS Grid": [
    ...
    "<li>The <code>'gap'</code> property in CSS Grid is used to set the spacing between grid columns and rows. It allows you to create gutters or margins between grid items to give your layout some space</li></ol>",
  ],  
  "CSS Navigation Bar": [
